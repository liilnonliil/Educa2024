...
![<img alt="banner educa 2024" src="image/banner-educa-2024-2.png" width="400" >](image/banner-educa-2024-2.png | width=400)
...
![<img alt="login" src="image/login-page.png" width="350" >](image/login-page.png)
...
> 2. กดปุ่ม `ถัดไป`
> 3. ท่านจะได้รับ Email รหัส `OTP สำหรับรีเซ็ตรหัสผ่าน`เป็นตัวเลขจำนวน 6 หลัก รหัส OTP จะส่งจาก `Email no_reply@educathai.com เท่านั้น`หากถูกต้องแล้วให้กดที่คำว่า `ขอรหัสใหม่` ![alt text](image/Request-otp.png){width=200}
