...
> [!WARNING]
> โดยการกรอกข้อมูลในฟอร์มนี้ `ยังไม่ใช่การลงทะเบียนที่สมบูรณ์` แต่เป็นการส่งรายชื่อเพื่อรับ promotion code ส่วนลด 5% เมื่อชำระเงิน และเมื่อได้รับ code แล้วผู้ลงทะเบียนสามารถนำ code ไปลงทะเบียนเป็นรายบุคคลเพื่อใช้ในการ login เข้าอบรมออนไลน์และรับเกียรติบัตรต่อไป
